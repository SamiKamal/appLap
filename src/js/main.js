...
document.querySelector('.faq__content').addEventListener('click', (e) => {
    if (e.target.closest('.faq__card')){
        ...
        document.querySelector('.activeFAQ').style.paddingBottom = `${document.querySelector('.activeFAQ').children[1].children[0].offsetHeight + document.querySelector('.activeFAQ').children[0].offsetHeight + 50}px`
